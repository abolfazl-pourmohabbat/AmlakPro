...
class SiteSettingsAdmin(admin.ModelAdmin):
    fieldsets=(('هویت سایت',{'fields':('site_name','site_tagline','logo','hero_image')}),('رنگ‌ها',{'fields':('primary_color','secondary_color','background_color','text_color','accent_color','line_color')}),('منوی سایت',{'fields':('nav_home','nav_properties','nav_agents','nav_about','nav_contact','nav_favorites')}),('صفحه اصلی — Hero',{'fields':('hero_eyebrow','hero_title','hero_title_emphasis','hero_description','hero_search_label','hero_search_placeholder','hero_deal_label','hero_search_button')}),('صفحه اصلی — املاک ویژه',{'fields':('featured_eyebrow','featured_title','featured_link','empty_properties_text')}),('صفحه اصلی — سه مزیت',{'fields':('trust_1_title','trust_1_text','trust_2_title','trust_2_text','trust_3_title','trust_3_text')}),('صفحه درباره ما',{'fields':('about_eyebrow','about_title','about_intro','about_card_1_title','about_card_1_text','about_card_2_title','about_card_2_text','about_card_3_title','about_card_3_text')}),('صفحه تماس با ما',{'fields':('contact_eyebrow','contact_title','contact_intro','contact_phone_label','contact_mobile_label','contact_address_label','contact_cta_eyebrow','contact_cta_title','contact_cta_button')}),('پاورقی و شبکه‌های اجتماعی',{'fields':('footer_copyright','instagram_url','telegram_url')}))
