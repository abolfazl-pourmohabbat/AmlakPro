...
class SiteSettings(models.Model):
    ...
    def clean(self):
        ...
        for field in ('instagram_url','telegram_url'):
            value=getattr(self,field)
            if value:
